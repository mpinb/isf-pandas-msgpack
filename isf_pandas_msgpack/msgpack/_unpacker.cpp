...
static const char __pyx_k_isf_pandas_msgpack_msgpack__unpa_2[] = "isf_pandas_msgpack/msgpack/_unpacker.pyx";
/* #### Code section: decls ### */
...
#define __pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2 __pyx_string_tab[57]
#define __pyx_n_u_list_hook __pyx_string_tab[58]
#define __pyx_kp_u_list_hook_must_be_a_callable __pyx_string_tab[59]
#define __pyx_n_u_main __pyx_string_tab[60]
#define __pyx_n_u_max_array_len __pyx_string_tab[61]
#define __pyx_n_u_max_bin_len __pyx_string_tab[62]
#define __pyx_n_u_max_buffer_size __pyx_string_tab[63]
#define __pyx_n_u_max_ext_len __pyx_string_tab[64]
#define __pyx_n_u_max_map_len __pyx_string_tab[65]
#define __pyx_n_u_max_str_len __pyx_string_tab[66]
...
#define __pyx_n_u_next_bytes __pyx_string_tab[70]
#define __pyx_kp_u_no_default___reduce___due_to_non __pyx_string_tab[71]
#define __pyx_n_u_nread __pyx_string_tab[72]
#define __pyx_n_u_obj __pyx_string_tab[73]
#define __pyx_n_u_object_hook __pyx_string_tab[74]
#define __pyx_kp_u_object_hook_must_be_a_callable __pyx_string_tab[75]
#define __pyx_n_u_object_pairs_hook __pyx_string_tab[76]
#define __pyx_kp_u_object_pairs_hook_and_object_hoo __pyx_string_tab[77]
#define __pyx_kp_u_object_pairs_hook_must_be_a_call __pyx_string_tab[78]
#define __pyx_n_u_off __pyx_string_tab[79]
#define __pyx_n_u_packed __pyx_string_tab[80]
#define __pyx_n_u_pop __pyx_string_tab[81]
#define __pyx_n_u_pybuff __pyx_string_tab[82]
...
#define __pyx_n_u_read_array_header __pyx_string_tab[87]
#define __pyx_n_u_read_bytes __pyx_string_tab[88]
#define __pyx_n_u_read_map_header __pyx_string_tab[89]
#define __pyx_n_u_read_size __pyx_string_tab[90]
#define __pyx_kp_u_read_size_should_be_less_or_equa __pyx_string_tab[91]
...
#define __pyx_n_u_skip __pyx_string_tab[100]
...
static PyObject *__pyx_f_18isf_pandas_msgpack_7msgpack_9_unpacker_8Unpacker_read_from_file(struct __pyx_obj_18isf_pandas_msgpack_7msgpack_9_unpacker_Unpacker *__pyx_v_self) {
  ...
  /* "isf_pandas_msgpack/msgpack/_unpacker.pyx":377
 * 
 *     cdef read_from_file(self):
 *         next_bytes = self.file_like_read(             # <<<<<<<<<<<<<<
 *             min(self.read_size,
...
*/
      ...
      /* "isf_pandas_msgpack/msgpack/_unpacker.pyx":406
 *             if write_bytes is not None:
 *                 write_bytes(PyBytes_FromStringAndSize(
 *                     self.buf + prev_head, self.buf_head - prev_head))             # <<<<<<<<<<<<<<
 * 
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_isf_pandas_msgpack_msgpack__unpa_2, sizeof(__pyx_k_isf_pandas_msgpack_msgpack__unpa_2), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2 */
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2, __pyx_mstate->__pyx_n_u_default_read_extended_type, __pyx_k_Qa131, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2, __pyx_mstate->__pyx_n_u_unpackb, __pyx_k_4A__A_Q_a_a_a_6_r_j_Q_d_y_q_Qj, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[2] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2, __pyx_mstate->__pyx_n_u_unpack, __pyx_k_31_O1_7_6_d_1_q_8_JoQ, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[2])) goto bad;
  }
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[3] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2, __pyx_mstate->__pyx_n_u_feed, __pyx_k_A_4_q_awfF_AQa, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[3])) goto bad;
  }
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[4] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2, __pyx_mstate->__pyx_n_u_read_bytes, __pyx_k_A_1D_D_1_q_E_4_M_3auBgT_q_4z_awb, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[4])) goto bad;
  }
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[5] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2, __pyx_mstate->__pyx_n_u_unpack, __pyx_k_t81_a, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[5])) goto bad;
  }
  {
    __Pyx_PyCode_New_function_description descr = {2, 0, 0, 2, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 443, 20};
    PyObject* varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_write_bytes};
    __pyx_mstate_global->__pyx_codeobj_tab[6] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2, __pyx_mstate->__pyx_n_u_skip, __pyx_k_a_t81M, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[6])) goto bad;
  }
  {
    __Pyx_PyCode_New_function_description descr = {2, 0, 0, 2, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 453, 21};
    PyObject* varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_write_bytes};
    __pyx_mstate_global->__pyx_codeobj_tab[7] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2, __pyx_mstate->__pyx_n_u_read_array_header, __pyx_k_31_t81_q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[7])) goto bad;
  }
  {
    __Pyx_PyCode_New_function_description descr = {2, 0, 0, 2, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 461, 21};
    PyObject* varnames[] = {__pyx_mstate->__pyx_n_u_self, __pyx_mstate->__pyx_n_u_write_bytes};
    __pyx_mstate_global->__pyx_codeobj_tab[8] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_isf_pandas_msgpack_msgpack__unpa_2, __pyx_mstate->__pyx_n_u_read_map_header, __pyx_k_1_t81_Q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[8])) goto bad;
  }
  {
